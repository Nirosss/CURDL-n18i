...
function renderAddBookModal() {
  ...
  <h2 data-trans="add-book-title">Adding New Book Form</h2>
        <div class="container">
        <button title="Close" class="btn-remove" onclick="onCloseActionsModal()">X</button>
            <label><b data-trans="name">Book name</b></label>
            <input type="text" placeholder="Enter Book Name" data-trans="add-book-name" name="book-name" required>

            <label><b data-trans="price">Price</b></label>
            <input type="number"  placeholder="Enter Price" data-trans="price" name="book-price" required>
            <br>
            <label><b data-trans="book-cover">Book Cover</b></label>
            <input type="text" placeholder="Paste img URL" data-trans="update-img-ph" name="imgURL" >
                   <div class="clearfix">
                <button data-trans="cancel" type="button" onclick="onCloseActionsModal()" class="cancel-btn">Cancel</button>
                <button data-trans="update" type="submit" class="form-submit-btn" onclick="onSubmitBook(event)"></button>
            </div>
        </div>
    </form>
</div>
...
<h2 data-trans="update-modal-title">Updating Book Info</h2>
    <form class="modal-content">
        <div class="container">
              <label><b>Price</b></label>
            <input type="number" placeholder="Enter New Price" data-trans="price" name="book-price" required>
            <label><b>Book Cover</b></label>
            <input type="text" placeholder="Update Book img URL" data-trans="update-img-ph" name="imgURL" >
                   <div class="clearfix">
                <button type="button" onclick="onCloseActionsModal()" class="cancel-btn" data-trans="cancel">Cancel</button>
                <button type="submit" class="form-submit-btn" onclick="onSubmitUpdate(event)" data-trans="update">Update Details</button>
            </div>
        </div>
    </form>
</div>
